      ...
      <div class="container-fluid">
        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="nav-link welcome">
                <div> <span class="link-instruction">New here?</span><a id="register-link"><span class="text">Register</span></a></div>
            </li>
            <li class="nav-link welcome">
                <div><span class="link-instruction">Already have an account?</span><a id="signin-link"><span class="text">Sign in</span></a></div>
            </li>
        </ul>
      </div><!-- /.container-fluid -->
...
<div class="container-fluid">
    <div class="row" id="welcome">
        <div class="col-md-6 col-sm-6">
            <img src="img/priyanka-image.jpg" alt="Talerang Express">
        </div>
        <div class="col-md-6 col-sm-6">
           <img src="img/express_youtube.jpg" alt="Talerang Express Video" href="https://www.youtube.com/watch?v=lo9seG8dE2k&rel=0" data-lity style="cursor:pointer">
        </div>
    </div>
    ...
    <div class="row page-section" id="WRAP">
        <div class="col-xs-12 col-sm-6by col-md-6 image">
            <div class="img-wrap">
    ...
    <div class="row page-section" id="mock">
        <div class="col-xs-12 col-sm-6 col-md-6 image">
            <div class="img-wrap">
            <p class="pictitle">Get a Mentor</p>
