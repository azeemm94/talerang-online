...
<head>
    ...
    <link href="css/loginstyle5.css?version=3.1<?php echo uniqid(); ?>" rel="stylesheet">
...
<div class="container-fluid" style="text-align: center; font-size: 20px; font-weight: bold">
    <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-6">
            8 week<br>program
        </div>
        <div class="col-md-3 col-sm-6 col-xs-6">
            Online and<br>Self-Paced
        </div>
        <div class="col-md-3 col-sm-6 col-xs-6">
            College to<br>Corporate
        </div>
        <div class="col-md-3 col-sm-6 col-xs-6">
            Access to<br>Jobs &amp; Internships
        </div>
    </div>
</div>
