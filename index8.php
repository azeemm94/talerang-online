...
<head>
    ...
    <link href="css/loginstyle.css?version=3.5" rel="stylesheet">
...
{   
    ...
    if (mysqli_query($DBcon, $sql) && !in_array($_SERVER['REMOTE_ADDR'],array('127.0.0.1','::1')))
    {   
        $sql="INSERT INTO `register`(`firstname`,`lastname`,`email`,`password`,`country`,`state`,`city`,`college`,`aboutus`,`regtime`,`active`,`accountno`) VALUES('$firstname','$lastname','$emailregister','$encodedpw','$country','$state','$city','$colname','$hear','$date','0','$accountno');";
        $edusynch=true;
        require 'connectsql.php';
...
{   
    ...
    if(!in_array($page,array('genz','jhe','mock','mockform','teststart','industry','skilltraining','dashboard','resumecreate','placement','placementregister','upload'))) //only these pages allowed for redirect
    ...
    if ($result = $DBcon->query("SELECT * FROM `register` WHERE `email`='$signinemail' LIMIT 1;")) 
    {
    ...
    <div class="row page-section" id="WRAP">
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 image">
            <div class="img-wrap">
                ...
                <img src="img/resume-writing-home.jpg" alt="Resume Creator">
            </div>
        </div><!-- Resume Creator -->
        <div class="col-xs-12 col-sm-6 col-md-4 image">
            <div class="img-wrap">
...
<script type="text/javascript" src="js/loginvalidator.js?version=1.8"></script>
