...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/style.css?version=2.2"/>
    <link rel="stylesheet" type="text/css" href="css/radiocheckbox.css?version=1.2" />
        ...
        <div id="page-wrap" class="container">
            ...
            <div class="tab-pane" id="fifth">
                 <?php //Competency : Prioritization ?>
                    ...
                    <p id="pri2">Drag and drop options into the gray boxes to create your lists</p>
                    ...
                    <input type='text' class="displaynone" id='question-15-answers-2' name='question15answers2' value=''/>
                        ...
                        <!-- </div>end col-md-6
                        <div class="col-md-6"> -->
                            <ul id="top3" class="droptrue sortablepri2 sortable col-md-6 col-xs-12">
                                <p class="ui-state-disabled" pri2-id="X">3 most important tasks</p>
                            </ul>
                            <ul id="bottom3" class="droptrue sortablepri2 sortable col-md-6 col-xs-12">
                ...
                <div class="scenario" style="margin-top: 7%; border-width: medium">
                    <div style="padding-left: 0;">
                        <div style="margin-left: 40px;">
                            ...
                            <span><label for="agree" class="error"></label></span>
                        </div>
                        <div style="margin-left: 40px;">
